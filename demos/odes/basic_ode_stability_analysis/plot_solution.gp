...
plot 'RESLT/euler_h_0.1.dat' using 1:2 title 'h = 0.1' w linespoints ls 1, \
     'RESLT/euler_h_0.01.dat' using 1:2 title 'h = 0.01' w linespoints ls 2, \
     'RESLT/euler_h_0.001.dat' using 1:2 title 'h = 0.001' w linespoints ls 3
...
plot 'RESLT/rk4_h_0.1.dat' using 1:2 title 'h = 0.1' w linespoints ls 1, \
     'RESLT/rk4_h_0.01.dat' using 1:2 title 'h = 0.01' w linespoints ls 2, \
     'RESLT/rk4_h_0.001.dat' using 1:2 title 'h = 0.001' w linespoints ls 3
...
plot 'RESLT/am2pc_h_0.1.dat' using 1:2 title 'h = 0.1' w linespoints ls 1, \
     'RESLT/am2pc_h_0.01.dat' using 1:2 title 'h = 0.01' w linespoints ls 2, \
     'RESLT/am2pc_h_0.001.dat' using 1:2 title 'h = 0.001' w linespoints ls 3
