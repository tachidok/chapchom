function yawerror = importfile_yaw_error(filename, startRow, endRow)
%IMPORTFILE Import numeric data from a text file as a matrix.
%   YAWERROR = IMPORTFILE_yaw_error(FILENAME) Reads data from text file FILENAME for
%   the default selection.
%
%   YAWERROR = IMPORTFILE_yaw_error(FILENAME, STARTROW, ENDROW) Reads data from rows
%   STARTROW through ENDROW of text file FILENAME.
%
% Example:
%   yawerror = importfile_yaw_error('yaw_error.dat', 1, 19533);
%
%    See also TEXTSCAN.

% Auto-generated by MATLAB on 2016/09/13 12:59:21
