/** \file This file implements the CCODEsFromTableBasedOnAcceleration2 class
 */
#include "cc_odes_from_table_based_on_acceleration2.h"

// ===================================================================
// Constructor, sets the number of odes. We currently have two odes,
// one for the velocity and the other for the acceleration
// ===================================================================
CCODEsFromTableBasedOnAcceleration2::CCODEsFromTableBasedOnAcceleration2()
 : CAODEs(7), DIM(3)
{
...
// ===================================================================
void CCODEsFromTableBasedOnAcceleration2::load_table(const char *filename)
{
...
// ======================================================================
void CCODEsFromTableBasedOnAcceleration2::get_sensors_lecture(const double t,
 ...
 if (do_interpolation)
  {
   ...
   gyro[0] = interpolator_pt->interpolate_1D(time, gyro_x, t, interpolation_order);// * (M_PI / 180.0); HERE Are the lectures given in radians or degress?
...
// ===================================================================
void CCODEsFromTableBasedOnAcceleration2::
...
// ===================================================================
void CCODEsFromTableBasedOnAcceleration2::multiply_matrix_times_vector(std::vector<std::vector<double> > &A,
                                                                       std::vector<double> &b,
                                                                       std::vector<double> &x)
{
...
// vector
// ===================================================================
void CCODEsFromTableBasedOnAcceleration2::evaluate(const double t,
                                                   ...
                                                   std::vector<double> &dy)
{
 ...
 dy[2] = vel[1];
 dy[3] = acc[1];
 dy[4] = euler_angles_rates[0];
 dy[5] = euler_angles_rates[1];
 dy[6] = euler_angles_rates[2];
...
// ===================================================================
void CCODEsFromTableBasedOnAcceleration2::evaluate(const unsigned i, const double t,
                                                   const std::vector<double> &y,
                                                   std::vector<double> &dy)
{
 // Error message
