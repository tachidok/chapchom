#ifndef CCODESFROMTABLEBASEDONACCELERATION2_H
#define CCODESFROMTABLEBASEDONACCELERATION2_H
...
class CCODEsFromTableBasedOnAcceleration2 : public CAODEs
{
 ...
 CCODEsFromTableBasedOnAcceleration2();
 
 /// Empty destructor
 virtual ~CCODEsFromTableBasedOnAcceleration2();
 ...
 /// copiable. Check
 /// http://www.learncpp.com/cpp-tutorial/912-shallow-vs-deep-copying/
 void operator=(const CCODEsFromTableBasedOnAcceleration2 &copy)
  {
   BrokenCopy::broken_assign("CCODEsFromTableBasedOnAcceleration2");
  }
...
#endif // #ifndef CCODESFROMTABLEBASEDONACCELERATION2_H
