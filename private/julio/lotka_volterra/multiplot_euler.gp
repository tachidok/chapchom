...
set tics scale 0.75
set title 'Euler time plot'

plot 'soln0_euler.dat' using 1:2 title 'Prey' w linespoints ls 1, \
     'soln0_euler.dat' using 1:3 title 'Predator' w linespoints ls 2
...
set tics scale 0.75
set title 'Euler phase plot'

plot 'soln0_euler.dat' using 2:3 w linespoints ls 1
