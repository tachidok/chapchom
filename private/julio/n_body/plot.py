...
t, x1, vx1, y1, vy1, z1, vz1, x2, vx2, y2, vy2, z2, vz2, x3, vx3, y3, vy3, z3, vz3, x4, vx4, y4, vy4, z4, vz4 = np.loadtxt(filename, delimiter='\t', unpack=True)
...
plt.plot(t, x4, label='$x_4$', color='purple', linestyle='dashdot', linewidth=Linewidth)
plt.grid()
...
plt.plot(t, y4, label='$y_4$', color='purple', linestyle='dashdot', linewidth=Linewidth)
plt.grid()
#plt.xticks(np.arange(0,10,step=1))
#plt.yticks(np.arange(0,1.1,step=0.1))
#plt.xlim([0,10])
...
plt.plot(t, z4, label='$z_4$', color='purple', linestyle='dashdot', linewidth=Linewidth)
plt.grid()
#plt.xticks(np.arange(0,10,step=1))
#plt.yticks(np.arange(0,1.1,step=0.1))
#plt.xlim([0,10])
...
plt.plot(x4, y4, label='$body_4$', color='purple', linestyle='dashdot', linewidth=Linewidth)
plt.grid()
#plt.xticks(np.arange(0,10,step=1))
#plt.yticks(np.arange(0,1.1,step=0.1))
#plt.xlim([0,10])
