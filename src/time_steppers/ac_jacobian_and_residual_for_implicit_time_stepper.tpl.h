...
namespace chapchom
{
 ...
 template<class MAT_TYPE, class VEC_TYPE>
  class ACJacobianAndResidualForImplicitTimeStepper : virtual public ACJacobianAndResidual<MAT_TYPE,VEC_TYPE>
  {
  ...
  private:
   ...
   ACJacobianAndResidualForImplicitTimeStepper(const ACJacobianAndResidualForImplicitTimeStepper<MAT_TYPE,VEC_TYPE> &copy)
    {
   ...
   // case). Check
   // http://www.learncpp.com/cpp-tutorial/912-shallow-vs-deep-copying/
   void operator=(const ACJacobianAndResidualForImplicitTimeStepper<MAT_TYPE,VEC_TYPE> &copy)
    {
