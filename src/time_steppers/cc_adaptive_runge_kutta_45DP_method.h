...
namespace chapchom
{
 ...
 /// @class CCAdaptiveRK45DPMethod cc_adaptive_runge_kutta_45_method.h
 /// This class implements the Dormand-Prince method for Runge-Kutta
 /// 4(5) to integrate ODE's
 class CCAdaptiveRK45DPMethod : public virtual ACTimeStepper
 {
 ...
 public:
  ...
  /// from current time "t" to the time "t+h". The values of u at time
